      ...
      <div className="container">
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <p>
              Film, sound, and music production.<br />
              A Venturer by MAS Mediaworks Studio LLP.<br />
              Based in Warje, Pune since 2017.
            </p>
          </div>
        ...
        <div className="footer-bottom">
          <p>© {year} MediaWorks Studio. All rights reserved.</p>
          <p>Office No. 105, 106, 107 — Mairah Enclave, Canal Road, Warje, Pune 411058</p>
        </div>
      </div>
    </footer>
  );
